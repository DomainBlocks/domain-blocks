using DomainBlocks.Experimental.Persistence.SourceGenerators.Tests.Utils;
using Microsoft.CodeAnalysis.CSharp;
using NUnit.Framework;

namespace DomainBlocks.Experimental.Persistence.SourceGenerators.Tests;
...
Customer";
    ...
    public void GenerateClassesBasedOnDDDRegistry()
    {
        ...
        Assert.That(generatedFiles, Is.EquivalentTo(new[]
        {
            "User.g.cs",
            "Document.g.cs",
            "Customer.g.cs"
