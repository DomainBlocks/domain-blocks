...
/// <summary>
/// The store proper over a client the caller owns. Wired by <see cref="KurrentDBEventStore.Create{TEvent}"/> and
/// <see cref="KurrentDBEventStoreBuilder{TEvent}"/>, which present it behind <see cref="KurrentDBEventStore{TEvent}"/>.
/// </summary>
internal sealed class KurrentDBEventStoreCore<TEvent>(
    ...
    where TEvent : notnull
{
    ...
    // The core holds no resources of its own; the public face disposes a client it owns.
