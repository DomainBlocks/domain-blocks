    ...
    where TEvent : notnull
{
    ...
    public IAsyncEnumerable<SubscriptionMessage2<TEvent, string, StreamPosition, Position>> SubscribeToAll(
    ...
    public IAsyncEnumerable<SubscriptionMessage2<TEvent, string, StreamPosition, Position>> SubscribeToStream(
        string streamId,
