...
public class ImmutableShoppingCartTests
{
    ...
    public void RoundTripTest()
    {
        ...
        var newState1 = events1.Aggregate(initialState, ShoppingCartFunctions.EventApplier);
        ...
        var newState2 = events2.Aggregate(newState1, ShoppingCartFunctions.EventApplier);
        ...
        var stateFromEvents = eventLog.Aggregate(new ShoppingCartState(), ShoppingCartFunctions.EventApplier);
