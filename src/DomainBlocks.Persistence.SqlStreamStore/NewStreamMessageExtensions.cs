...
{
    public static NewStreamMessage ToNewStreamMessage(this IEventSerializer<string> @eventSerializer, object @event, string eventNameOverride = null, params KeyValuePair<string, string>[] additionalMetadata)
    {
