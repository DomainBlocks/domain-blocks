...
/// </summary>
public readonly record struct StreamState2<TVersion> where TVersion : notnull
{
    ...
    /// </summary>
    public static readonly StreamState2<TVersion> DoesNotExist = new(StreamStateKind.DoesNotExist);

    private readonly TVersion? _version;

    private StreamState2(StreamStateKind kind, TVersion? version = default)
    {
        Kind = kind;
        _version = version;
    }
    ...
    /// </summary>
    public static StreamState2<TVersion> AtVersion(TVersion version)
    {
        ArgumentNullException.ThrowIfNull(version);
        return new StreamState2<TVersion>(StreamStateKind.AtVersion, version);
    }
