...
/// <summary>
/// Exposes read-only operations for a repository of events.
/// </summary>
public interface IReadOnlyEventRepository<out TReadEvent, TStreamVersion> where TStreamVersion : struct
{
    /// <summary>
