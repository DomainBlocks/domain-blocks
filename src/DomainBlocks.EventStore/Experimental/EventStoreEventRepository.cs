...
public sealed class EventStoreEventRepository : IEventRepository<ResolvedEvent, EventData, StreamRevision>
{
    private static readonly ILogger<EventStoreEventRepository> Logger = Log.Create<EventStoreEventRepository>();
    private readonly EventStoreClient _client;

    public EventStoreEventRepository(EventStoreClient client)
    {
