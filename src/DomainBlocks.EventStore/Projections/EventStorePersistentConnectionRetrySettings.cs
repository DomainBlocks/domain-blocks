...
{
    public EventStorePersistentConnectionRetrySettings(
        int maxRetryCount, 
    ...
    public static readonly EventStorePersistentConnectionRetrySettings Default = new(
        3, 
    ...
    public TimeSpan GetRetryDelay(int retryNumber)
    {
        ...
        return retryNumber > RetryDelays.Length ? RetryDelays[^1] : RetryDelays[retryNumber - 1];
    }
}