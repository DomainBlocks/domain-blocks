...
public class ProjectionOptions<TState> : IProjectionOptions
{
    ...
    public ProjectionRegistry Register(ProjectionRegistry registry)
    {
        ...
        {
            throw new InvalidOperationException("No resource factory specified");
        }

        if (_stateFactory == null)
        {
            throw new InvalidOperationException("No state factory specified");
        }

        if (_onSave == null)
        {
            throw new InvalidOperationException("No on-save callback specified");
        }
