...
public class EventCodecTests
{
    ...
    /// <summary>
    /// Writes "TypeName:OrderId" for the record types above.
    /// </summary>
    private sealed class FakeObjectSerializer : IObjectSerializer<string>
    {
    ...
    private sealed class FakeMetadataSerializer : IMetadataSerializer<string>
    {
