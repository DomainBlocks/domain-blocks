...
namespace DomainBlocks.Serialization.Google.Protobuf.Tests.Unit;

public class ProtobufBytesObjectSerializerTests
{
    private readonly ProtobufBytesObjectSerializer _serializer = new();
    ...
    public void Should_serialize_and_deserialize()
    {
        ...
        var deserialized = (Proto.UserCreated?)_serializer.Deserialize(bytes, typeof(Proto.UserCreated));
